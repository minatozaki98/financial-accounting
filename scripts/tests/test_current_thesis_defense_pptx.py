...
class CurrentThesisDefenseTests(unittest.TestCase):
    ...
    def test_committee_notes_are_plain_and_point_to_evidence(self):
        ...
        self.assertIn("Bugs 0 · Vulnerabilities 0", sonar_explanation)
        self.assertIn("Duplicated-line density 0.0%", sonar_explanation)
        self.assertIn("0.1 percentage point", sonar_explanation)
