...
LISTINGS = [
    ...
    },
    {
        ...
        "purpose": "Locks down the expected security-header defaults and the p50/p500 gate thresholds used by the application configuration.",
        "verification": "Related evidence: fresh JMeter remediation failure against the configured p100 and p500 thresholds.",
        "fragments": [
...
DASHBOARDS = [
    ...
    ("jmeter/jmeter-baseline-p50-dashboard.png", "Apache JMeter baseline p50"),
    ("jmeter/jmeter-baseline-p100-dashboard.png", "Apache JMeter baseline p100"),
    ("jmeter/jmeter-baseline-p500-dashboard.png", "Apache JMeter baseline p500"),
    ...
    ("jmeter/jmeter-remediation-p50-dashboard.png", "Apache JMeter remediation p50"),
    ("jmeter/jmeter-remediation-p100-dashboard.png", "Apache JMeter remediation p100"),
    ("jmeter/jmeter-remediation-p500-dashboard.png", "Apache JMeter remediation p500"),
...
def rebuild_code_appendices(report_path: Path, root: Path = ROOT) -> int:
    ...
    add_table(
        ...
        [
            ...
            ["Apache JMeter", "Core gate FAIL; p50 33 to 199.9 ms; p100 255.9 to 1146.9 ms; p500 106 to 1547.95 ms; soak/spike aggregates improved", "Earlier run reported core and stress p95 improvements", "docs/appendix/verification-runs/research/jmeter/*"],
