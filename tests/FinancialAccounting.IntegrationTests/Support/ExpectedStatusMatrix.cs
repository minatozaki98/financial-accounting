...
public static class ExpectedStatusMatrix
{
    public static readonly IReadOnlyDictionary<string, IDictionary<string, int>> EndpointRoleStatus =
        new Dictionary<string, IDictionary<string, int>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["GET /periods/{id}/close-preview"] = new Dictionary<string, int> { ["Admin"] = 200, ["FinanceManager"] = 200, ["User"] = 403, ["Auditor"] = 403, ["Anonymous"] = 401 },
            ...
            ["POST /journal-imports/validate"] = new Dictionary<string, int> { ["Admin"] = 200, ["FinanceManager"] = 200, ["User"] = 403, ["Auditor"] = 403, ["Anonymous"] = 401 },
            ...
            ["POST /reconciliations"] = new Dictionary<string, int> { ["Admin"] = 201, ["FinanceManager"] = 201, ["User"] = 403, ["Auditor"] = 403, ["Anonymous"] = 401 },
