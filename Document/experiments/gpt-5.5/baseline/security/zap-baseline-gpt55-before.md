...
| Info | Informational | http://host.docker.internal:5296 | Percentage of responses with status code 2xx | 69 % |
| Info | Informational | http://host.docker.internal:5296 | Percentage of responses with status code 3xx | 15 % |
| Info | Informational | http://host.docker.internal:5296 | Percentage of responses with status code 4xx | 15 % |
| Info | Informational | http://host.docker.internal:5296 | Percentage of endpoints with content type application/javascript | 9 % |
| Info | Informational | http://host.docker.internal:5296 | Percentage of endpoints with content type image/png | 18 % |
| Info | Informational | http://host.docker.internal:5296 | Percentage of endpoints with content type text/css | 18 % |
| Info | Informational | http://host.docker.internal:5296 | Percentage of endpoints with content type text/html | 9 % |
| Info | Informational | http://host.docker.internal:5296 | Percentage of endpoints with content type text/javascript | 18 % |
| Info | Informational | http://host.docker.internal:5296 | Percentage of endpoints with method GET | 100 % |
| Info | Informational | http://host.docker.internal:5296 | Count of total endpoints | 11    |
| Info | Informational | http://host.docker.internal:5296 | Percentage of slow responses | 7 % |
...
* URL: http://host.docker.internal:5296/swagger/index.js
  ...
  * Evidence: ``
  * Other Info: ``
* URL: http://host.docker.internal:5296/swagger/swagger-ui.css
  * Node Name: `http://host.docker.internal:5296/swagger/swagger-ui.css`
  * Method: `GET`
  * Parameter: `Cross-Origin-Resource-Policy`
  * Attack: ``
  * Evidence: ``
